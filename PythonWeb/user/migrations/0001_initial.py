# Generated by Django 3.0 on 2020-06-01 09:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GioiTinh', models.CharField(choices=[('0', 'Nam'), ('1', 'Nữ'), ('2', 'Không xác định')], default='2', max_length=20, verbose_name='Giới tính')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MaSP', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sanpham.SanPham')),
            ],
        ),
    ]
