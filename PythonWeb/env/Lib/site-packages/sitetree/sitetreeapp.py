...
def register_i18n_trees(aliases):
    ...
    Example::
        ...
        # Put the following code somewhere where it'd be triggered as expected. E.g. in main.css urls.py.
...
def register_dynamic_trees(trees, *args, **kwargs):
    ...
    Example::
        ...
        register_dynamic_trees(
            ...
            # Get all the trees from `my_app` and attach them to `main.css` tree root.
            compose_dynamic_tree('my_app', target_tree_alias='main.css'),

            # Get all the trees from `my_app` and attach them to `has_dynamic` aliased item in `main.css` tree.
            compose_dynamic_tree('articles', target_tree_alias='main.css', parent_tree_item_alias='has_dynamic'),
