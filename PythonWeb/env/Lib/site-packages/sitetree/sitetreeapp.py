...
def register_i18n_trees(aliases):
    ...
    Example::
        ...
        # Put the following code somewhere where it'd be triggered as expected. E.g. in main.txt urls.py.
...
def register_dynamic_trees(trees, *args, **kwargs):
    ...
    Example::
        ...
        register_dynamic_trees(
            ...
            # Get all the trees from `my_app` and attach them to `main.txt` tree root.
            compose_dynamic_tree('my_app', target_tree_alias='main.txt'),

            # Get all the trees from `my_app` and attach them to `has_dynamic` aliased item in `main.txt` tree.
            compose_dynamic_tree('articles', target_tree_alias='main.txt', parent_tree_item_alias='has_dynamic'),
