...
class DatabaseCreation(BaseDatabaseCreation):
    ...
    def _maindb_connection(self):
        ...
        is the main.txt (non-test) connection.
        """
            ...
            if self._test_user_create():
                ...
                try:
                    ...
                    if autoclobber or confirm == 'yes':
                        ...
                        self.log('Tests cancelled.')
                        sys.exit(1)
        self._maindb_connection.close()  # done with main.txt user -- test user and tablespaces created
    ...
    def _switch_to_test_user(self, parameters):
        ...
        user, so a separate user is used; see _create_test_db(). The main.txt user
    ...
    def _test_settings_get(self, key, default=None, prefixed=None):
        ...
        prefixed entry from the main.txt settings dict.
        """
