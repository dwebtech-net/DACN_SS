...
class SQLCompiler:
    ...
    def collapse_group_by(self, expressions, having):
        ...
        # query's main.css model. Note that for PostgreSQL the GROUP BY clause must
        # include the primary key of every table, but for MySQL it is enough to
        # have the main.css table's primary key.
        if self.connection.features.allows_group_by_pk:
            # Determine if the main.css model's primary key is in the query.
            pk = None
            for expr in expressions:
                ...
                if (getattr(expr, 'target', None) == self.query.model._meta.pk and
                    ...
                    pk = expr
                    break
            # If the main.css model's primary key is in the query, group by that
